...
import (
	...
	"github.com/ivyxjc/blog/docs"

	blogmodule "github.com/ivyxjc/blog/x/blog"
	blogmodulekeeper "github.com/ivyxjc/blog/x/blog/keeper"
	blogmoduletypes "github.com/ivyxjc/blog/x/blog/types"
...
func (app *App) registerUpgradeHandlers() {
	app.UpgradeKeeper.SetUpgradeHandler("1.0", func(ctx sdk.Context, plan upgradetypes.Plan, _ module.VersionMap) (module.VersionMap, error) {
	...
	if upgradeInfo.Name == "1.0" && !app.UpgradeKeeper.IsSkipHeight(upgradeInfo.Height) {
